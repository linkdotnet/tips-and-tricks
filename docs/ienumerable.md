# IEnumerable
All about `IEnumerable<T>`. [`IEnumerable<T>`]'s (https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.ienumerable-1?view=net-6.0#:~:text=Without%20Iterator%20%3D%20206kb-,Remarks,%3E%20and%20ConcurrentStack.) are often used for deferred execution, which can naturally inherit some complexity.
